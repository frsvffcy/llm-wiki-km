...
- `target/llm-wiki-km-<version>.jar`（例如目前 main 的開發版識別 `llm-wiki-km-0.3.0.jar`）為 Spring Boot executable JAR（含歷史版本同等內容；v0.1.0 / v0.1.1 / v0.2.0 / v0.2.1 JAR 保持不可變，見對應 tag），含全部 Java 應用碼、
