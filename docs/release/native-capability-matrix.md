...
- `target/llm-wiki-km-<version>.jar`（例如 current `llm-wiki-km-0.2.1.jar`）為 Spring Boot executable JAR（含歷史版本同等內容；v0.1.0 / v0.1.1 / v0.2.0 JAR 保持不可變，見對應 tag），含全部 Java 應用碼、
