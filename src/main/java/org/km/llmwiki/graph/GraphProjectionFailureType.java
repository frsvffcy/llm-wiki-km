...
public enum GraphProjectionFailureType {
    CAPABILITY_DISABLED("GRAPH_CAPABILITY_DISABLED", false),
    ...
    BACKEND_LOCKED("GRAPH_BACKEND_LOCKED", true),
    FILESYSTEM_UNAVAILABLE("GRAPH_FILESYSTEM_UNAVAILABLE", true),
    PROJECTION_CORRUPT("GRAPH_PROJECTION_CORRUPT", false),
    INVALID_TRAVERSAL_BOUNDS("GRAPH_INVALID_TRAVERSAL_BOUNDS", false),
    TRANSACTION_FAILURE("GRAPH_TRANSACTION_FAILURE", true),
    CONFIGURATION_INVALID("GRAPH_CONFIGURATION_INVALID", false),
